...
import { removeAllNotes, setFilter } from "../../redux-saga/redux/Notes/noteSlice";
        ...
        <div className="row">
          ...
          <div className="col-lg-6">
            <div style={{"marginLeft": "57%"}}>
              <CustomButton className="btn btn-danger" onClick={(e) => { dispatch(removeAllNotes());}} label="Delete All Notes" />
            </div>
          </div>
        </div>
        <div className="row">
